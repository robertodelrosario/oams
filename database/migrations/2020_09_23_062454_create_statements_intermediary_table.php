...
class CreateStatementsIntermediaryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('statements_intermediaries', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('statements_intermediary');
    }
}
